...
(function(c,a,b,e){b.network("hackernews",{script:{src:"//hnbutton.appspot.com/static/hn.js"}});var d=function(f){var g=a.createElement("a");g.className="hn-share-button";b.copyDataAttributes(f.el,g);f.el.appendChild(g)};b.widget("hackernews","share",{init:d,activate:function(f){if(c.HN){c.HN.render(f.el)}}})})(window,window.document,window.Socialite);

/*
 * MicrowaveJS (client-side javscript)
 */
 (function() {
